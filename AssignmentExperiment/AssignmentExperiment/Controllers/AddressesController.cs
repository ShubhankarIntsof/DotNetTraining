...
namespace MVC_First.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            ViewData["StateProvinceId"] = new SelectList(_context.StateProvinces, "StateProvinceId", "CountryRegionCode");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("AddressId,AddressLine1,AddressLine2,City,StateProvinceId,PostalCode,Rowguid,ModifiedDate")] Address address)
        {
            ...
            ViewData["StateProvinceId"] = new SelectList(_context.StateProvinces, "StateProvinceId", "CountryRegionCode", address.StateProvinceId);
            return View(address);
        }
